"""
Django settings for combat3 project.
...
ALLOWED_HOSTS = ["192.168.42.66", "10.97.138.179", "localhost", "127.0.0.1"]
...
WSGI_APPLICATION = 'combat3.wsgi.application'
